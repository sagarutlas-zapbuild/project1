# Generated by Django 2.2.10 on 2020-02-25 04:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_prospect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DatabaseAPI.prospect')),
            ],
        ),
        migrations.CreateModel(
            name='lead',
            fields=[
                ...
                ('lead_description', models.CharField(default='', max_length=1000)),
                ...
                ('lead_prospect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DatabaseAPI.prospect')),
            ],
        ),
        migrations.CreateModel(
            name='email',
            fields=[
                ...
                ('email_prospect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DatabaseAPI.prospect')),
            ],
        ),
        migrations.CreateModel(
            name='attachment',
            fields=[
                ...
                ('attachment_lead', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DatabaseAPI.lead')),
            ],
        ),
    ]
